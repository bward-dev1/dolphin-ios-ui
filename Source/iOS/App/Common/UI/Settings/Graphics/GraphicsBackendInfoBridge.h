...
// project). Extracted from the old GraphicsRootViewController.mm so the new
// Swift GraphicsRootViewController can still repopulate g_backend_info
// before any Graphics sub-screen reads capability flags off it — this is
